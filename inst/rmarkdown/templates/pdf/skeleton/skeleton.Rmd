...
author:
  - name: "Carlos Vergara Hernández"
    corresmail: "estadistica_fisabio@gva.es"
    affilnumber: 1
affil:
...
knitr::include_graphics(path = here::here("informes/extra/fisabio.png"), rel_path = FALSE)
```

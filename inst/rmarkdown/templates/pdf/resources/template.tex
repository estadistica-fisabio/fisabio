...
\fancyfoot[C]{
	...
	\begin{tabular}[b]{c}
		...
		\color{black}FUNDACIÓ PER AL FOMENT DE LA INVESTIGACIÓ SANITÀRIA I BIOMÈDICA DE LA COMUNITAT VALENCIANA (FISABIO).  \\
		\color{black}C/ Misser Mascó nº 31. 46010 València. CIF.: G98073760 Inscrita Registre fundacions: 501 V  \\
		\href{https://fisabio.san.gva.es/es/}{\color{black}fisabio.san.gva.es/es/}
	\end{tabular}%
}

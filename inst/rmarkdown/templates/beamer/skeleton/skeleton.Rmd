...
institute: "Servicio de Estudios estadísticos"
output:
  fisabio::informe:
    beamer: true
...
options(tikzMetricsDictionary = paste0(here::here() "/.tikzMetrics"))
###########################################################
...
```{r ejemplo_ev, fig.cap="Representación de la razón de mortalidad estandarizada (RME) por enfermedad isquémica en hombres en la Región de Aragón, 1991-2000", results="hide", fig.height=2.5, fig.width=4, eval = F}
source("configuracion/config.R")
library(sp)
library(RColorBrewer)
data("aragon_iam")
...
knitr::include_graphics(path = "informes/extra/se_fisabio.png")
```
...
```{r kable}
kable(mtcars[1:3, 3:7], digits = 2, align = rep("c", 7),

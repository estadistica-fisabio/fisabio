...
% Clase y página                                         %
%--------------------------------------------------------%
\documentclass[$if(fontsize)$$fontsize$,$endif$$if(handout)$handout,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{beamer}
\usetheme[$for(metropolisopts)$$metropolisopts$,$endfor$block=fill, progressbar=frametitle]{metropolis}
...
$endif$
\date{$date$}
\titlegraphic{\hfill\includegraphics[width=1.8cm,height=1.6cm]{extra/fisabio.png}}
